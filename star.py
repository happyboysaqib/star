...
$$\   $$ |$$ |  $$ |$$ $$\$$ | $$ |  $$ |  $$ |
\$$$$$$  |$$ |  $$ |\$$$$$$ /$$$$$$\ $$$$$$$  |
 \______/ \__|  \__| \___$$$\\______|\_______/ 
                         \___|                 
...
\033[1;91m [⚡\033[1;97mAuthor Name: saqib     ⚡\033[1;91m]
\033[1;91m [⚡\033[                                                    ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mWhatsApp: 03484160325  ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91msaqibYT\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
$$ /  \__|$$ /  $$ |$$ /  $$ | $$ |  $$ |  $$ |
\$$$$$$\  $$$$$$$$ |$$ |  $$ | $$ |  $$$$$$$\ |
 \____$$\ $$  __$$ |$$ |  $$ | $$ |  $$  __$$\ m«-_-_-_-_-_-_-_-_-\033[1;91mTALHA\033[1;95m-_-_-_-_-_-_-_-_-»
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #saqib.khan
	    time.sleep(2)
            loop = 'false'
        else:
        ...
        os.system('https://www.facebook.com/Termuxteasaqibkhan')
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribeYoutube Channel " 
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://commentpicker.com/find.id.php')
	        menu()
	elif unikers =="3":
...
def pilih_super():
	...
	p.map(main, id)
#Dev:saqib
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91saqibkhan\033[1;95m-_-_-_-_-_-_-_-_-»"
...
print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91saqib\033[1;95m-_-_-_-_-_-_-_-_-»"
